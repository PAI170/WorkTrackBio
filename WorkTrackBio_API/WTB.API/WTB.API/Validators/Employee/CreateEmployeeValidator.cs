...
{
    /// <summary>
    /// Validador para la creación de empleados con reglas de negocio específicas
    /// </summary>
    public class CreateEmployeeValidator : AbstractValidator<CreateEmployeeDto>
    {
        public CreateEmployeeValidator()
        {
            ...
            RuleFor(x => x.PhoneNumber)
                ...
                .WithMessage("El formato del teléfono debe ser nnnn-nnnn (formato Costa Rica)");
            ...
            RuleFor(x => x.EmergencyContactPhoneNumber)
                ...
                .WithMessage("El formato del teléfono de emergencia debe ser nnnn-nnnn (formato Costa Rica)");
        ...
        private string GetDocumentValidationMessage(int documentTypeId)
        {
            return (DocumentTypeEnum)documentTypeId switch
            {
                DocumentTypeEnum.CedulaIdentidad => "El formato de la cédula debe ser: n-nnnn-nnnn (ej: 1-1234-5678)",
                DocumentTypeEnum.Pasaporte => "El formato del pasaporte debe ser: 1-2 letras seguidas de 6-8 números (ej: A1234567, CR12345678)",
                DocumentTypeEnum.DIMEX => "El formato del DIMEX debe ser: DIM-nnnnnnnn (ej: DIM-123456789123)",
        ...
        /// <summary>
        /// Valida formato de Cédula de Identidad CR: n-nnnn-nnnn
        /// </summary>
        ...
        private bool BeValidName(string name)
        {
            ...
            return Regex.IsMatch(name, namePattern);
                ...
                private bool BeValidNameNull(string? name)
        {
            if (string.IsNullOrWhiteSpace(name))
                return false;
        ...
        /// <summary>
        /// Valida el formato de teléfono costarricense (nnnn-nnnn)
        /// </summary>
